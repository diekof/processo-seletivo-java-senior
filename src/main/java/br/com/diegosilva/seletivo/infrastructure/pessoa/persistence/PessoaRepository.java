package br.com.diegosilva.seletivo.infrastructure.pessoa.persistence;

import br.com.diegosilva.seletivo.domain.pessoa.EnderecoFuncionalPorNomeServidorPreview;
import br.com.diegosilva.seletivo.infrastructure.pessoa.models.ServidorEfetivoPorUnidadeIdCustom;
...
public interface PessoaRepository extends JpaRepository<PessoaJpaEntity,Long> {
    ...
    @Query("""
                SELECT 
                   new br.com.diegosilva.seletivo.infrastructure.pessoa.models.ServidorEfetivoPorUnidadeIdCustom(
                                p,
                                u.nome
                            )
                FROM PessoaJpaEntity p
    ...
    @Query("""
                SELECT 
                     distinct new br.com.diegosilva.seletivo.domain.pessoa.EnderecoFuncionalPorNomeServidorPreview(
                        e.endTipoLogradouro, 
                        e.endLogradouro, 
                        e.endNumero, 
                        e.endBairro, 
