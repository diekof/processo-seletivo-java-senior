package br.com.diegosilva.seletivo.infrastructure.lotacao.persistence;

import br.com.diegosilva.seletivo.domain.lotacao.LotacaoPreview;
...
public interface LotacaoRepository extends JpaRepository<LotacaoJpaEntity, Long> {
    @Query("""
            select 
                new br.com.diegosilva.seletivo.domain.lotacao.LotacaoPreview(
                 l.lotId,
                        l.lotDataLotacao,
                        l.lotDataRemocao,
                        l.lotPortaria,
